...
define('ARTIFACT_VALIDATION', [
    ...
    '*.champion_id' => 'integer',
    '*.sub_stats' => 'max_len,4',
    '*.sub_stats.*.Stats' => 'required|contains,HP;HP%;ATK;ATK%;DEF;DEF%;SPD;C.RATE;C.DMG;RESI;ACC',
    '*.sub_stats.*.Value' => 'required|integer|min_numeric,0',
    '*.sub_stats.*.Rune' => 'required|integer|min_numeric,0',
    '*.sub_stats.*.Roll' => 'required|integer|min_numeric,0',
...
define('CHAMPION_VALIDATION', [
    ...
    'hp' => 'required|integer|min_numeric,0',
    'acc' => 'required|integer|min_numeric,0',
    'atk' => 'required|integer|min_numeric,0',
    'def' => 'required|integer|min_numeric,0',
    'crate' => 'required|integer|min_numeric,0',
    'cdmg' => 'required|integer|min_numeric,0',
    'res' => 'required|integer|min_numeric,0',
    'spd' => 'required|integer|min_numeric,0',
    'masteries' => 'required',
    'masteries.*' => 'alpha',
